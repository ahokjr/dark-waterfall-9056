...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/dark-waterfall-9056#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dark-waterfall-9056
```

A live public deployment of this template is available at [https://dark-waterfall-9056.templates.workers.dev](https://dark-waterfall-9056.templates.workers.dev)
